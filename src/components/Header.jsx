          ...
          <>
                    ...
                    <Menu as="div" className="ml-3 relative">
                      ...
                      >
                        <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                          ...
                          <Disclosure.Button onClick={auth.logout} className="block px-4 py-2 text-sm text-gray-700">
                            Logout
                          </Disclosure.Button>
                        </Menu.Items>
                      </Transition>
            ...
            <Disclosure.Panel className="md:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <Disclosure.Button onClick={auth.logout} className="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700">
                  Logout
                </Disclosure.Button>
              </div>
