...
const Pagination = ({ totalItems, itemsPerPage, neighbours, setOffset }) => {
  ...
  return (
    <div className="bg-red px-4 py-3 flex items-center justify-between border-t border-blue-200 sm:px-6">
      <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
        <div>
          <p className="text-sm text-gray-700">
            Mostrando <span className="font-medium">{itemsPerPage * (current - 1) + 1}</span> to{' '}
